...
// let students = [
//     { id: 1, name: "Ashraf Gad", age: 24, phone: "01553585239", address: "Menoufia, Egypt" },
...
// //             success: false,
// //             message: "name, age, phone, address are all required"
// //         });
// //     }
...
const express = require('express');
const studentRouter = require('./src/Modules/user/user.router.js');
